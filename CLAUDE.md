# SuperDev Claude Code Instructions

Claude Code should follow the SuperDev standard whenever it performs substantial development, refactoring, planning, or architecture work in a long-lived repository or module.
